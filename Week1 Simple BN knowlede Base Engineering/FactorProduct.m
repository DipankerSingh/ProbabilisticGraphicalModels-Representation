...
assignments = IndexToAssignment(1:prod(C.card), C.card); %return the assignments for a particular index 
indxA = AssignmentToIndex(assignments(:, mapA), A.card); %return the index of differentCombinations of var of A
indxB = AssignmentToIndex(assignments(:, mapB), B.card); %return the index of differentCombinations of var of B
