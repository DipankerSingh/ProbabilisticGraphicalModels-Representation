...
for i = 1:numAlleles
   for j = 1:numAlleles
      genotypeFactor.val(1,allelesToGenotypes(i,j)) = alleleFreqs(i) * alleleFreqs(j);
      if i != j
      genotypeFactor.val(1,allelesToGenotypes(i,j)) = 2 * genotypeFactor.val(allelesToGenotypes(i,j));
      end 
   end 
end
